...
$(document).ready(function () {
  // .winners .block .navs .next
  $(".winners .block .navs .prev").click(function () {
    $(".block .owl-prev").click();
  });
  $(".winners .block .navs .next").click(function () {
  ...
  $(".scroll-pane").jScrollPane(); // $(".defaultbanner").click();
  // calculate();
...
function popup(n) {
  ...
  $(".popup").fadeOut(222);
  $(n).fadeIn(444);
  $(n).css("top", $(window).scrollTop() + 50 + "px"); // $('body').addClass('hid');
...
function closex() {
  event.preventDefault(); //  $('body').css('height','')
